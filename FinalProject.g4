...
methodDeclaration: WS*'public' WS* type WS* Identifier WS* '(' WS* ( type WS* Identifier WS*
( ',' WS* type WS* Identifier WS* )* )? ')' WS* '{' WS* (methodBody)
WS* 'return' WS* expression WS* ';' WS* '}' WS*;
...
'('? WS* ',' WS* Identifier WS* ')'? WS* | WS* INTEGER_LITERAL WS* |
